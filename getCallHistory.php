...
// This is for datatables web interface AJAX
...
if (isset($config['obihai']['host'])) {
   ...
   die('You must configure software first.');
}
...
$jsonresponse = json_decode(callHistoryJson($raw_response),true);
$dataTable = array('data'=>$jsonresponse);
